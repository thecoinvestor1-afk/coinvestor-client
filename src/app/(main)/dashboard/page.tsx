                ...
                <div className="mb-4 sm:mb-6 lg:mb-8">
                    <div className="flex flex-col gap-4 sm:gap-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                            {/* Investment Timer */}
                            <Card className="px-4 py-3 sm:px-6 sm:py-4 flex-1">
                                <div className="flex items-center gap-3">
                                    <Timer className="w-5 h-5 sm:w-6 sm:h-6 text-primary flex-shrink-0" />
                                    <div className="min-w-0">
                                        <p className="text-xs sm:text-sm text-gray-600">Next Maturity</p>
                            ...
                            <Card className="px-4 py-3 sm:px-6 sm:py-4 flex-1">
                                <div className="flex items-center gap-3">
                                    <Wallet className="w-5 h-5 sm:w-6 sm:h-6 text-green-600 flex-shrink-0" />
            ...
            <main className="w-full px-3 sm:px-4 lg:px-8 pb-8">
                <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
                    ...
                    <div className="w-full">
                        <TabsList className="grid grid-cols-3 grid-rows-2 w-full sm:flex sm:w-full h-20 sm:h-12 p-1 gap-1">
